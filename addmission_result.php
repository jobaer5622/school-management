		...
		<div class="row">
			<div class="col-md-9 float-left border">
                ...
                <div class="container">
                    <div class="row" >
                        <div class="col-12" >
                                    <form action="addmission_result_show.php" method="post" id="">
                                        <div class="card border-primary rounded-0">
                                            <div class="card-header p-0">
                                                <div class="bg-info text-white text-center py-2">
                                                    <h3>Addmission Result Search</h3>
                                                </div>
                                            </div>
...
<?php } } ?>
                                            ...
                                            <div class="form-group row">
                                                ...
                                                <div class="text-center">
                                                    <input name="searchResult" type="submit" value="Search" class="btn btn-success btn-block rounded-0 py-2">
                                                </div>
                                            </div>
